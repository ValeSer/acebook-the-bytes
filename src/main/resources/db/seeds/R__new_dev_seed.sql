...
CREATE TABLE notifications (
  ...
  post_id bigint null,  -- Change from INT to BIGINT
  comment_id bigint null,  -- Change from INT to BIGINT
  friendship_id bigint null,  -- Change from INT to BIGINT
  chat_id bigint null,  -- Change from INT to BIGINT
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
